            ...
            <form action="startPayment.php" method="POST">
                 ...
                 <table>
                    <!-- Item Details - Actual values set in apiCallsData.php -->
                     <tr><td>Product </td><td><input class="form-control" type="text" name="camera_amount" value="35" readonly></input></td></tr>
                     <tr><td>Tax </td><td><input class="form-control" type="text" name="tax" value="1.75" readonly></input> </td></tr>
                     <tr><td>Total Amount </td><td><input class="form-control" type="text" name="total_amount" value="36.75" readonly></input> </td></tr>
