            ...
            <form action="startPayment.php" method="POST">
                 ...
                 <table>
                    <!-- Item Details - Actual values set in apiCallsData.php -->
                     <tr><td>Product </td><td><input class="form-control" type="text" name="camera_amount" value="30" readonly></input></td></tr>
                     <tr><td>Tax </td><td><input class="form-control" type="text" name="tax" value="1.50" readonly></input> </td></tr>
                     <tr><td>Total Amount </td><td><input class="form-control" type="text" name="total_amount" value="31.50" readonly></input> </td></tr>
