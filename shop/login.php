...
<li style="background-image: url(images/field.jpg);">
    ...
    <div class="form">
      ...
      <div class="tab-content">
          ...
          <h1>Welcome</h1>
          <!--<h2>Welcome to AltEx</h2>-->
          <form action="login.php" method="post" name="loginform"> <!--onsubmit="return validate()"-->
            <div class="field-wrap">
              <label>
                Username<span class="req"></span>
              </label>
              <input type="text"required autocomplete="off" name="usernameInput" id="usernameInput" maxlength="50" />
            </div>
            ...
            <div class="field-wrap">
              ...
              <input type="password"required autocomplete="off" name="passwordInput" id="passwordInput" maxlength="50" />
            </div>

            <button type="submit" id="btnSubmit" name="btnSubmit" class="button button-block"/>Login</button>
